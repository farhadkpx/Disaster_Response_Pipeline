...
def file_process_argument():
    ...
    parser.add_argument("--model_type", default=1, type=int, choices={1, 2},\
                        help="Choose 1 for RandomForest Classifier with Tfidf\
...
def build_model(model_type):
    ...
    model_cv = GridSearchCV(pipeline, param_grid=parameters, cv=5, verbose=2, n_jobs=-1)
    return model_cv
